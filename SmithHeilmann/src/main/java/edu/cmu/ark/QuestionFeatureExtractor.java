...
public class QuestionFeatureExtractor {
	...
	public static LanguageModel getForwardLM() {
		if(forwardLM == null){
			forwardLM = new LanguageModel(ClassLoader.getSystemResource(GlobalProperties.getProperties().getProperty("languageModelFile", "config"+File.separator+"languageModel.txt")).getFile());
		}
		return forwardLM;
	}
